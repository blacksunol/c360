...
<div class="rule_item">
    <div id="addScnt" class="btn btn-success">Thêm rule</div>
        ...
        <?php
            if(@$_GET['id']>0){
                $item['rules'] = '{"level":[{"from":"10","to":"20","items":[{"item_id":"660143","name":"Tr\u1ee9ng B\u0103ng Long","count":"1","rate":"1"},{"item_id":"800073","name":"H\u1ed7 R\u0103ng Ki\u1ebfm","count":"1","rate":"1"}]},{"from":"10","to":"20","items":[{"item_id":"660143","name":"Tr\u1ee9ng B\u0103ng Long","count":"1","rate":"1"},{"item_id":"800073","name":"H\u1ed7 R\u0103ng Ki\u1ebfm","count":"1","rate":"1"}]},{"from":"20","to":"30","items":[{"item_id":"660143","name":"Tr\u1ee9ng B\u0103ng Long","count":"1","rate":"1"},{"item_id":"800073","name":"H\u1ed7 R\u0103ng Ki\u1ebfm","count":"1","rate":"1"}]},{"from":"30","to":"40","items":[{"item_id":"660143","name":"Tr\u1ee9ng B\u0103ng Long","count":"1","rate":"1"},{"item_id":"800073","name":"H\u1ed7 R\u0103ng Ki\u1ebfm","count":"1","rate":"1"}]}]}';
            }else{
                $item['rules'] = '';
            }
        ...
        <div class="item_rule">
            ...
            <div class="btn_addsub btn btn-warning" keyrule_<?php echo $i;?>="<?php echo $i;?>" id="addVar_<?php echo $i;?>">Thêm điều kiện</div>
            <div class="sublist">
                <?php
                    if(count($vrule)>0){
                        $j=0;
                ...
                <div class="sub_item_rule" id="sub_item_rule">
                    ...
                    <script>
                        $(function() {
                            //cap 3
                            var z=<?php echo count($vcon['items']);?>;
                            $('#addVarSub_<?php echo $j;?>').live('click', function() {
                    ...
                    <div class="subsublist">
                        <?php
                            if(count($vcon['items'])>0){
                                $z=0;
                                foreach($vcon['items'] as $k=>$v){
                                    $z++;
                        ?>
   ...
   $(function() {
        ...
        $('#addScnt').live('click', function() {
            ...
            var html = '<div class="item_rule">';
                    ...
                    html +='<div id="addVar" keyrule="'+x+'" class="btn_addsub btn btn-warning">Thêm điều kiện</div><div class="sublist"></div>';
                html +='</div>';
