...
(function($) {
	...
	$.cookie = function(name, value, options) {
		if (typeof value != 'undefined') {
			...
			// cookieValue = '0,0|1,1|2,2|0,3|1,4|2,5';
			//cookieValue = '0,0|0,3|0,4|1,1|2,2|2,5';
	...
	$.fn.jDashboard = function(opts) {
		...
		return this.each(function() {
			...
			if(cookiesOn) {
				...
				$.cookie("jdash-index-" + $db.attr("id"), cooks, { expires: 365 });
				//alert(cook);
